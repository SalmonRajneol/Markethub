...
<form action="customerJ_action4.php" method="get" name="form" onSubmit="return VerifyForm(this)">
  <table width="59%" border="0" cellspacing="0" cellpadding="5">
    <tr> 
      ...
      <td width="76%"><input name="cusFirst" type="text" id="cusFirst" value="<?php echo $cusFirst;?>" size="20" maxlength="20"></td>
    </tr>
    <tr> 
    ...
    <tr> 
      ...
      <td><input name="cusStreet" type="text" id="cusStreet" value="<?php echo $cusStreet;?>" size="40" maxlength="40"></td>
    </tr>
    <tr> 
